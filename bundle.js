...
/******/ 	var hotCurrentHash = "d90aed371b306c9a6b71"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(5); // load bootstrap 3
	...
	$(document).ready(function (){
		...
		// 		console.log('data length is: ' + buildings.length);
		// 	});
		// api.hermosa.getResidential()
		// 	.then(function(buildings) {
		// 		console.log('data length is: ' + buildings.length);
		// 	});
